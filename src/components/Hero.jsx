...
export default function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex items-center justify-center min-h-[90vh]">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-brand-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center">
        ...
        >
          <span className="text-brand-600 font-medium tracking-wider text-sm uppercase mb-4 block">Elevated Living Spaces</span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#services" onClick={scrollToServices} className="px-8 py-4 bg-gray-900 text-white rounded-full font-medium hover:bg-gray-800 transition-all w-full sm:w-auto flex items-center justify-center gap-2 cursor-pointer">
              Book a Service
            </a>
            <Link to="/shop" className="px-8 py-4 bg-white text-gray-900 border border-gray-200 shadow-sm rounded-full font-medium hover:border-gray-300 hover:shadow-md transition-all w-full sm:w-auto flex items-center justify-center gap-2 group">
              Shop Equipment
